...
function Header() {
  ...
  return (
   <div className="p-3 flex justify-between items-center h-20">
      <img src="/flytrip.png" alt="" className="w-36 h-auto cursor-pointer" onClick={()=>window.location.href='/'}/>
      <div>
        {user ? (
          <div className="flex items-center gap-4">
            ...
            <a href="/my-trips">
            <Button variant="outline" className="rounded-full bg-[#1E3A8A] text-white hover:bg-[#FF8C00] hover:text-black">
              My Trips
            </Button>
            </a>
          ...
          <Button className='bg-[#1E3A8A] text-white' onClick={()=>setopenDialog(true)}>Sign In</Button>
        )}
      </div>
       {/* dialog box */}
